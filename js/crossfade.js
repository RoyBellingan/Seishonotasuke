...
$(document).ready(function() {
	//RICORDA "." sono le classi "#" sono gli ID!

	var idz=['edp','edilizia_cond','interni','impiantistica_res','terra','noleggio'];
	//var idzlen=idz.length;

	
	/*
	$(".div").bind('mouseenter',function()
		{//Quando il mouse entra su UNA imagine
			var id_on = $(this).attr('id'); //Vedo su che ID sono
			id_on=id_on.substring(3)
			...
			for (i=0;i<=idz.length;i++)
			{
				...
				{//Alza il cosino
					...
					var str = "#"+id_no+"_over";
					//alert(str);
					$(str).animate({"bottom": "+=74px"}, "fast");
				}
				else
				{
					$("#"+id_no).fadeTo("fast", 0);
					$("#"+id_no+"_over").animate({ 'bottom': '-74px'}, "fast");
				}
	...
	$(".outer").bind('mouseleave',function()
		{
			...
			{
				id_on=idz[i];
				//var id_on = $(this).attr('class'); //Vedo su che ID sono
				$("#"+id_on).fadeTo("fast", 1);
				$("#"+id_on+"_over").animate({ 'bottom': '-74px'}, "fast");
			};
		});
		*/
	});