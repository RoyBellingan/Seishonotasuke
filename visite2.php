                    ...
                    <li>
                        ...
                        <ul class="subnav" style="width:750px;" >
                            <div id="full" >
                                ...
                                <input name="interlineare" type="checkbox" value="1" onclick="setinter(this)" > Interlineare ?
                                </form>
<li id="Pentateuco">
    Pentateuco
    <dl>
...
<div align="center" id="footer"> <hr width="66%" size=1 color="silver"> Served with proud by susi in LESS secs. </div></body>